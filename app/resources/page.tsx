...
export default function ResourcesPage() {
  return <><SiteHeader /><main className="inner-main" id="main-content" tabIndex={-1}>
    ...
    <section className="official-help"><div><p className="section-kicker light">Official reporting</p><h2>Use primary sources, not search ads.</h2><p>These links go directly to U.S. government reporting resources. If you are elsewhere, use your national cybercrime, consumer protection, or police reporting channel.</p></div><div className="official-links"><a href="https://reportfraud.ftc.gov/" target="_blank" rel="noreferrer"><strong>FTC ReportFraud</strong><span>Report fraud, scams, and bad business practices ↗<span className="sr-only"> (opens in a new tab)</span></span></a><a href="https://www.ic3.gov/" target="_blank" rel="noreferrer"><strong>FBI Internet Crime Complaint Center</strong><span>Report internet-enabled crime ↗<span className="sr-only"> (opens in a new tab)</span></span></a><a href="https://www.identitytheft.gov/" target="_blank" rel="noreferrer"><strong>IdentityTheft.gov</strong><span>Create an identity-theft recovery plan ↗<span className="sr-only"> (opens in a new tab)</span></span></a></div></section>
