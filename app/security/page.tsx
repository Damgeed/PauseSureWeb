...
export default function Security() {
  return <LegalShell title="Security at PauseSure." intro="PauseSure uses least privilege, protected storage, secure connected-data handling, strict validation, and explicit product limits throughout the service.">
    <p className="legal-date">Security overview · Updated 28 August 2026</p>
    ...
    <p>A feature should not receive unrelated device content simply because another permission was granted. Screenshot checks validate source type, encoded size, dimensions, and decoded pixel count, then rasterize the selected image into a bounded JPEG or PNG before upload. Analysis responses are size-bounded and contract-validated. Connected services are reviewed for narrow access, encryption, retention, notification privacy, and deletion. Public disclosures must match the network behavior of the released build.</p>
