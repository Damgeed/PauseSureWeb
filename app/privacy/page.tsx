...
export default function Privacy() {
  return <LegalShell title="Privacy should feel understandable." intro="This Privacy Notice explains how PauseSure handles personal data across the website, browser checker, and iPhone app features you choose to use.">
    ...
    <div className="legal-notice">The public checker processes the text, link, phone number, screenshot, or QR image you choose inside your browser and does not upload that checked content. The checker does not fetch a submitted destination. PauseSure does not run behavioral advertising or sell personal data.</div>
