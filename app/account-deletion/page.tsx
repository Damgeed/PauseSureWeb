...
export default function AccountDeletion() {
  return <LegalShell title="Delete your PauseSure account." intro="Account deletion should be easy to start, clear about what it covers, and confirmed when complete.">
    ...
    <div className="legal-notice">If you use a connected PauseSure account, start deletion from the in-app account controls. The browser checker does not create or use a PauseSure account; content you deliberately submit is sent to PauseSure’s analysis service under the Privacy Notice.</div>
    ...
    <h2>What deletion covers</h2><p>A completed deletion request covers the account record and account-linked service data that PauseSure is not legally required to retain. The confirmation process identifies any records stored by the iPhone app or exports that must be removed separately.</p>
