...
export default function Support() {
  return <LegalShell title="Get the right help." intro="Find official scam-response resources, PauseSure support boundaries, and the correct contact route without exposing sensitive information.">
    ...
    <h2>Use PauseSure now</h2><p>The browser checker runs on pausesure.com and keeps checked content in your browser. It does not contact a phone number, open a submitted destination, or promise that an item with no detected signals is safe. Review the <a href="/product">iPhone app toolkit</a> and <a href="/safety">protection-check boundaries</a> for the rest of the product flow.</p>
  </LegalShell>;
}
