...
export const metadata = pageMetadata({ title: "Terms", description: "Terms governing use of the PauseSure website, browser checker, and informational resources.", path: "/terms" });

export default function Terms() {
  return <LegalShell title="PauseSure terms" intro="These terms govern your use of the PauseSure website, browser checker, and informational resources. Any service-specific terms are shown with the applicable service.">
    <p className="legal-date">Terms · Effective 26 August 2026</p>
    <div className="legal-notice">PauseSure provides decision support and scam-safety education. Nothing on this website or in a PauseSure result guarantees protection, detection, recovery, identity, or a particular outcome.</div>
    ...
    <h2>Changes and service-specific terms</h2><p>The effective date changes when these terms are materially updated. App, account, subscription, eligibility, or other service-specific terms are shown before use of the applicable service.</p>
    <h2>Questions</h2><p>Start from the <a href="/support">PauseSure Support page</a> for current help routes. Do not send legal, identity, payment, or account information through an address or contact route that is not listed on pausesure.com.</p>
  </LegalShell>;
}
